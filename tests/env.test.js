...
describe('Environment Variable Validation', () => {
  describe('validateSecret', () => {
    ...
    it('should throw error for secret lacking complexity', () => {
    ...
    it('should pass for a complex secret', () => {
  ...
  describe('getEnv', () => {
    it('should return value for existing env variable', () => {
      process.env.TEST_VAR = 'test_value';
      expect(getEnv('TEST_VAR')).toBe('test_value');
      delete process.env.TEST_VAR;
    });

    it('should return default value for non-existing env variable', () => {
      expect(getEnv('NON_EXISTING_VAR', 'default')).toBe('default');
    });

    it('should throw error for non-existing env variable without default', () => {
